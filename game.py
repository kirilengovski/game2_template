...
def list_of_items(items):
    ...
    if not items:
        ...
        return ', '.join(str(i["name"]) for i in list(items))
...
def print_room_items(room):
    ...
    """
    z = list_of_items(room["items"])
    if str(z) == "":
        pass
    else:
        print ("There is " + str(z) + " here.")
        print ("")
...
def print_inventory_items(items):
    ...
    """
    n = list_of_items(inventory)
    if str(n) == "":
        pass
    else:
        print("You have " + str(n) + ".")
        print("")
...
def print_menu(exits, room_items, inv_items):
    ...
    for k in room_items:
        print("TAKE " + k["id"].upper() + " to take " + k["name"] + ".")

    for p in inv_items:
        print("DROP " + p["id"].upper() + " to drop your " + p["name"] + ".")
